                 ...
                 <div id="hptab2" class="tab-pane fade">
                       <form onsubmit="return false">
                                        						...
                                        						<div class="form-group row" style="padding: 0 20px">
                                        						    <p style="color: #ffffff; font-style: italic "> *Chọn loại nhà trọ và khoảng giá, sau đó bấm vào biểu tượng
				...
				<div class="container">
					...
					<div class="row room-hot">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="container"><h3 class="title-comm"><span class="title-holder">NHÀ TRỌ MỚI NHẤT</span></h3>
					<div class="row room-hot">
